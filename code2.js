const buttons = [];
const images = [
    'колокола', 'недоуздок', 'стремена', 'гель', 'затылочный', 'капсюль', 'ленчик', 'мундштук',
    'налобный', 'нахвостник', 'нащечный', 'повод', 'подпруга', 'путлища',
    'седло', 'чомбур', 'трензель', 'попона', 'ногавки', 'меховушка', 'бинты', 'ватники', 'вальтрап', 'щетка',
    'хлыст', 'уздечка', 'подкова', 'корда', 'шлем', 'крючок'
];
